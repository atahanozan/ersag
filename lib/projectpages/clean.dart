...
class CleanPageView extends StatefulWidget {
  const CleanPageView({Key? key}) : super(key: key);

  @override
  State<CleanPageView> createState() => _CleanPageViewState();
}

class _CleanPageViewState extends State<CleanPageView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Temizlik Ürünleri"),
        actions: [
          IconButton(
              onPressed: () {
                Navigator.push(
      ...
      body: Padding(
        ...
        child: StreamBuilder(
          stream: _ekleService.getUrunTemizlik(),
