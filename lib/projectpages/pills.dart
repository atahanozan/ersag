...
class PillsPageView extends StatefulWidget {
  const PillsPageView({super.key});

  @override
  State<PillsPageView> createState() => _PillsPageViewState();
}

class _PillsPageViewState extends State<PillsPageView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Takviye Gıdalar"),
        actions: [
          IconButton(
              onPressed: () {
                Navigator.push(
      ...
      body: Padding(
        ...
        child: StreamBuilder(
          stream: _ekleService.getUrunTemelGida(),
