...
class CosmaticsPageView extends StatefulWidget {
  const CosmaticsPageView({Key? key}) : super(key: key);

  @override
  State<CosmaticsPageView> createState() => _CosmaticsPageViewState();
}

class _CosmaticsPageViewState extends State<CosmaticsPageView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Kozmetik Ürünleri"),
        actions: [
          IconButton(
              onPressed: () {
                Navigator.push(
      ...
      body: Padding(
        ...
        child: StreamBuilder(
          stream: _ekleService.getUrunKozmetik(),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: const DecorationImage(
                                        image:
                                            AssetImage('assets/cosmetic.png'),
                                        fit: BoxFit.cover)),
                              ),
                              Container(
